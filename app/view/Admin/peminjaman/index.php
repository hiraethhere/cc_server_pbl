                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 text-xs font-medium text-gray-900">3 November 2025
                                    <br>
                                    <span>12:00 - 14:00</span>
                                </td>
                                <td class="px-6 py-4 text-xs text-gray-900">Ruangan Lentera Edukasi</td>
                                <td class="px-6 py-4 text-xs text-gray-900">5F098HAK</td>
                                <td class="px-6 py-4 text-xs text-gray-900">Muhammad Reza Arifin</td>
                                <td class="px-6 py-4">
                                    <span class="inline-flex px-3 py-1 text-xs font-medium rounded-sm min-w-5/6 justify-center bg-[#C90B0B] text-[#FBFCFF]">
                                        Ditolak
                                    </span>
                                </td>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 text-xs text-gray-900">Muhammad Reza Arifin</td>
                                <td class="px-6 py-4">
                                    <span class="inline-flex px-3 py-1 text-xs font-medium rounded-sm min-w-5/6 justify-center bg-[#1E68FB] text-[#FBFCFF]">
                                        Dipinjam
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-center">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 text-xs text-gray-900">Muhammad Reza Arifin</td>
                                <td class="px-6 py-4">
                                    <span class="inline-flex px-3 py-1 text-xs font-medium rounded-sm min-w-5/6 justify-center bg-[#38C55C] text-[#FBFCFF]">
                                        Diterima
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-center">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 text-xs text-gray-900">Muhammad Reza Arifin</td>
                                <td class="px-6 py-4">
                                    <span class="inline-flex px-3 py-1 text-xs min-w-5/6 justify-center font-medium rounded-sm bg-[#38C55C] text-[#FBFCFF]">
                                        Selesai
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-center">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 text-xs text-gray-900">Muhammad Reza Arifin</td>
                                <td class="px-6 py-4">
                                    <span class="inline-flex px-3 py-1 text-xs min-w-5/6 justify-center font-medium rounded-sm bg-[#C90B0B] text-[#FBFCFF]">
                                        Ditolak
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-center">
