<main class="flex-1 p-8 overflow-y-auto bg-background1">
    ...
    <div class="space-y-4 bg-background2 shadow-xl rounded-xl p-6 mt-8">
        ...
        <div>
            ...
            Tata Tertib (maksimal 255 karakter)
            </label>
            <textarea rows="6" placeholder="Tuliskan deskripsi lengkap ruangan..." maxlength="255"
        ...
        <div class="flex gap-8 pt-2">
            <button class="flex-1 bg-green1 hover:bg-green-700 text-white font-semibold py-3 rounded-xl shadow-lg hover:shadow-xl transition transform hover:cursor-pointer">
            Edit Tata Tertib
            </button>
        </div>
