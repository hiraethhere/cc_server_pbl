...
class s_20251119_03_userSeeder extends Seeder{
    ...
    public function run()
    {
        ...
        $sql = "INSERT IGNORE INTO users ( id_user,
            ...
            (6, 3, 'Shidqi Athallah Bahri', '$passwordUser', 'shidqi.tik24@stu.pnj.ac.id', '2407411038', 'Teknik Informatika dan Komputer', 'D4 Teknik Informatika', 'active', 0, 1, NULL, NULL, NULL, NULL , NOW(), NOW()),
            (7, 4, 'Nadiva Mecca Rimanda', '$passwordUser', 'mecca.tik24@stu.pnj.ac.id', '2407411037', 'Teknik Informatika', NULL, 'active', 0, 1, NULL, NULL, NULL, NULL , NOW(), NOW()),
