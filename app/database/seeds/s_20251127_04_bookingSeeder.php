...
class s_20251127_04_bookingSeeder extends Seeder{
    public function run()
    {
        ...
        $sql = "INSERT INTO bookings (id_booking,
            ...
            (6, 3, 7, 5, NULL, '$upcoming_start', '$upcoming_end', 'BK-NEXT', 'pending', NULL, NULL, '$now', '$now'),
            (7, 1, 8, 4, NULL, '2025-12-03 13:00:00', '2025-12-03 15:00:00', 'DUTAPNJ', 'pending', NULL, NULL, NOW(), NOW()),
            (8, 1, 6,  4, NULL, '2025-01-01 10:00:00', '2025-01-01 12:00:00', 'DNIWW987', 'cancelled', NULL, NULL, NOW(), NOW()),
